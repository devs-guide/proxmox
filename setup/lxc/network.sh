...
NETWORK_SELF_URL="${PROXMOX_LXC_NETWORK_SELF_URL:-${PAGES_BASE_URL}/setup/lxc/network.sh}"
NETWORK_SUDO_REEXEC="${PROXMOX_LXC_NETWORK_SUDO_REEXEC:-0}"
...
collect.sudo.env.args() {
  ...
  _out=(
    "PROXMOX_LXC_NETWORK_MODE=${FEATURE_MODE}"
    "PROXMOX_LXC_NETWORK_INTERACTIVE=${FEATURE_INTERACTIVE}"
    "PROXMOX_LXC_NETWORK_ALLOW_HOST=${FEATURE_ALLOW_HOST}"
    "PROXMOX_LXC_NETWORK_ASSUME_CONTAINER=${FEATURE_ASSUME_CONTAINER}"
    "PROXMOX_LXC_NETWORK_REQUIRE_CONTAINER=${FEATURE_REQUIRE_CONTAINER}"
    "PROXMOX_LXC_NETWORK_ENABLE_SSH=${FEATURE_ENABLE_SSH}"
    "PROXMOX_LXC_NETWORK_ENABLE_UFW=${FEATURE_ENABLE_UFW}"
    "PROXMOX_LXC_NETWORK_ENABLE_FUSE_CLIENT=${FEATURE_ENABLE_FUSE_CLIENT}"
    "PROXMOX_LXC_NETWORK_ENABLE_AVAHI=${FEATURE_ENABLE_AVAHI}"
    "PROXMOX_LXC_NETWORK_EXPECTED_DNS=${FEATURE_EXPECTED_DNS}"
    "PROXMOX_LXC_NETWORK_INTERNET_PROBE_IPV4=${FEATURE_INTERNET_PROBE_IPV4}"
    "PROXMOX_LXC_NETWORK_ACCESS_PROFILE=${FEATURE_ACCESS_PROFILE}"
    "PROXMOX_LXC_NETWORK_SFTP_ENABLED=${FEATURE_SFTP_ENABLED}"
    "PROXMOX_LXC_NETWORK_SFTP_REQUIRE_SUBSYSTEM=${FEATURE_SFTP_REQUIRE_SUBSYSTEM}"
    "PROXMOX_LXC_NETWORK_SFTP_VALIDATE_BINARY=${FEATURE_SFTP_VALIDATE_BINARY}"
    "PROXMOX_LXC_NETWORK_SFTP_SUBSYSTEM_NAME=${FEATURE_SFTP_SUBSYSTEM_NAME}"
    "PROXMOX_LXC_NETWORK_SFTP_SUBSYSTEM_PATH=${FEATURE_SFTP_SUBSYSTEM_PATH}"
    "PROXMOX_LXC_NETWORK_ALLOW_SUBNETS=${FEATURE_ALLOW_SUBNETS}"
    "PROXMOX_LXC_NETWORK_ACCESS_USERS=${FEATURE_ACCESS_USERS}"
    "PROXMOX_LXC_NETWORK_SSH_PORT=${FEATURE_SSH_PORT}"
    "PROXMOX_LXC_NETWORK_FACTS_DIR=${FACTS_DIR}"
    "PROXMOX_LXC_NETWORK_CONTAINER_FACTS_PATH=${NETWORK_CONTAINER_FACTS_PATH}"
    "PROXMOX_LXC_NETWORK_RUNTIME_FACTS_PATH=${NETWORK_RUNTIME_FACTS_PATH}"
    "PROXMOX_LXC_NETWORK_SELECTION_PATH=${NETWORK_SELECTION_PATH}"
    "PROXMOX_CTID=${CONTAINER_CTID}"
    "PROXMOX_CTNAME=${CONTAINER_CTNAME}"
    "PROXMOX_LXC_NETWORK_SELF_URL=${NETWORK_SELF_URL}"
    "PROXMOX_LXC_NETWORK_SUDO_REEXEC=1"
...
main() {
  ensure.root.or.sudo.reexec "${NETWORK_SUDO_REEXEC}" "${NETWORK_SELF_URL}" "$@"
  require.root
  require.apt
  require.valid.mode
  detect.container.identity
