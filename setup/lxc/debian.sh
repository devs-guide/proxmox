...
collect.sudo.env.args() {
  ...
  _out=(
    "PROXMOX_LXC_DEBIAN_MODE=${FEATURE_MODE}"
    "PROXMOX_LXC_DEBIAN_OPERATION=${FEATURE_OPERATION}"
    "PROXMOX_LXC_DEBIAN_INTERACTIVE=${FEATURE_INTERACTIVE}"
    "PROXMOX_LXC_DEBIAN_ALLOW_CONTAINER=${FEATURE_ALLOW_CONTAINER}"
    "PROXMOX_LXC_DEBIAN_ENABLE_UFW=${FEATURE_ENABLE_UFW}"
    "PROXMOX_LXC_DEBIAN_TEMPLATE_BASE_URL=${DEBIAN_LXC_TEMPLATE_BASE_URL}"
    "PROXMOX_LXC_DEBIAN_HOSTNAME=${DEFAULT_HOSTNAME}"
    "PROXMOX_LXC_DEBIAN_CTID=${DEFAULT_CTID}"
    "PROXMOX_LXC_DEBIAN_TEMPLATE=${DEFAULT_TEMPLATE}"
    "PROXMOX_LXC_DEBIAN_TEMPLATE_MAJOR=${DEFAULT_TEMPLATE_MAJOR}"
    "PROXMOX_LXC_DEBIAN_STORAGE=${DEFAULT_ROOTFS_STORAGE}"
    "PROXMOX_LXC_DEBIAN_ROOTFS_GB=${DEFAULT_ROOTFS_SIZE_GB}"
    "PROXMOX_LXC_DEBIAN_CORES=${DEFAULT_CORES}"
    "PROXMOX_LXC_DEBIAN_MEMORY_MB=${DEFAULT_MEMORY_MB}"
    "PROXMOX_LXC_DEBIAN_SWAP_MB=${DEFAULT_SWAP_MB}"
    "PROXMOX_LXC_DEBIAN_BRIDGE=${DEFAULT_BRIDGE}"
    "PROXMOX_LXC_DEBIAN_VLAN_TAG=${DEFAULT_VLAN_TAG}"
    "PROXMOX_LXC_DEBIAN_IPV4_MODE=${DEFAULT_IPV4_MODE}"
    "PROXMOX_LXC_DEBIAN_IPV4_CIDR=${DEFAULT_IPV4_CIDR}"
    "PROXMOX_LXC_DEBIAN_GATEWAY=${DEFAULT_GATEWAY}"
    "PROXMOX_LXC_DEBIAN_UNPRIVILEGED=${DEFAULT_UNPRIVILEGED}"
    "PROXMOX_LXC_DEBIAN_NESTING=${DEFAULT_NESTING}"
    ...
    "PROXMOX_LXC_DEBIAN_MOUNTS=${DEFAULT_MOUNTS}"
    "PROXMOX_LXC_DEBIAN_FACTS_DIR=${FACTS_DIR}"
    "PROXMOX_LXC_DEBIAN_CONTAINERS_TSV=${CONTAINERS_TSV_PATH}"
    "PROXMOX_LXC_DEBIAN_TEMPLATES_TSV=${TEMPLATES_TSV_PATH}"
    "PROXMOX_LXC_DEBIAN_ISOS_TSV=${ISOS_TSV_PATH}"
    "PROXMOX_LXC_DEBIAN_SELECTION_PATH=${SELECTION_PATH}"
    "PROXMOX_LXC_DEBIAN_RUNTIME_FACTS_PATH=${RUNTIME_FACTS_PATH}"
    "PROXMOX_LXC_DEBIAN_SELF_URL=${DEBIAN_SELF_URL}"
    "PROXMOX_LXC_DEBIAN_SUDO_REEXEC=1"
...
main() {
  ensure.root.or.sudo.reexec "${DEBIAN_SUDO_REEXEC}" "${DEBIAN_SELF_URL}" "$@"
  require.root
  require.apt
  require.valid.mode
  require.proxmox.host
